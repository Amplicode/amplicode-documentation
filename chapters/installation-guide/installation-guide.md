...
В настоящее время **все возможности Amplicode доступны бесплатно**. Ниже вы можете найти таблицу с версиями Amplicode, IntelliJ IDEA и датами, до которых лицензионная политика для соответствующих версий Amplicode не изменится. В будущем мы можем изменить лицензионную политику, но обязуемся предупредить об этом **не менее чем за полгода** до вступления изменений в силу.

| Версия Amplicode | Версия IntelliJ IDEA               | Частичное прекращение поддержки | Полное прекращение поддержки | Лицензионная политика |
|------------------|------------------------------------|---------------------------------|------------------------------|-----------------------|
| 2023.2.0-PRIVATE | 2022.3.X<br/>2023.2.X<br/>2023.3.X | 02.05.2024                      | 03.06.2024                   | Бесплатно             |
| 2024.1.X-EAP     | 2023.2.X<br/>2023.3.X<br/>2024.1.X | 02.09.2024                      | 01.10.2024                   | Бесплатно             |
| 2024.2.X-EAP     | 2023.2.X<br/>2023.3.X<br/>2024.1.X | 02.12.2024                      | 12.01.2025                   | Бесплатно             |


_**Частичное прекращение поддержки**: начиная с указанной даты, Amplicode будет предлагать обновиться до более свежей версии. Все функции Amplicode останутся доступны и продолжат работать как раньше._

_**Полное прекращение поддержки**: начиная с указанной даты, все возможности Amplicode станут недоступны до момента обновления на более свежую версию._
